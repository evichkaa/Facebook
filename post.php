...
<div id="posts">
    ...
    <div style="width: 100%;">
        ...
        <div style="font-weight: bold; color:#405d9d; float: left; width: 100%;">
            ...
            echo "<a href='profile.php?id=$row_userid'>";
...
//        }
        ...
        ?>
        <a href="single_post.php?id=<?php echo $row['postid']?>"> Comment <?php if(isset($comments)){echo $comments;} ?> </a> .
        ...
        <span style="color: #aaaaaa; float: right;">
            ...
            if($post->i_own_post($row['postid'],$_SESSION['facebook_userid'])){
                ...
                $row_postid = $row['postid'];
            echo "
        
            <a href='edit.php?id=$row_postid'>Edit
                </a> .
            <a href='delete.php?id=$row_postid'>Delete
                </a>";
        ...
        if(isset($_SESSION['facebook_userid'])){
            ...
            $sql = "select likes from likes where type = 'post' && id = '$row_postid' limit 1 ";
            $result = $DB->read($sql);
            if(is_array($result)){
        ...
        if($row['postid'] > 0){
            echo "<br/>";
            echo "<a href='likes.php?type=post&id=$row_postid'>";
            if($row['likes'] == 1){
